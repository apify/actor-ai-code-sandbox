...
- **Base image:** [Debian Trixie](https://www.debian.org/releases/trixie/) with [Node.js 26](https://nodejs.org/) and [Python 3](https://www.python.org/) (`venv` at `/sandbox/py/venv`).
