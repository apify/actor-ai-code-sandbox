...
- **Pre-installed tools:** [git](https://git-scm.com/), [openssh-client](https://www.openssh.com/), [curl](https://curl.se/), [wget](https://www.gnu.org/software/wget/), [jq](https://jqlang.org/), [build-essential](https://packages.debian.org/trixie/build-essential), [`tsx`](https://tsx.is/), and [`ttyd`](https://github.com/tsl0922/ttyd). The [`apify-cli`](https://docs.apify.com/cli/) and [`mcpc`](https://github.com/apify/mcpc) CLIs install automatically the first time they are run, which keeps the image small. The [`apify-client`](https://docs.apify.com/api/client/js/) library is preinstalled in the Node environment, and the [Python `apify-client`](https://docs.apify.com/api/client/python/) in the venv.
